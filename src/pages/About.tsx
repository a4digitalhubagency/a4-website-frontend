...
const About = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Story icons floating animation
        ...
        <Layout>
            ...
            <section className="bg-gradient-to-br from-white via-blue-50/30 to-white py-20 relative overflow-hidden">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-12">
                    <div className="lg:w-1/2 text-center lg:text-left z-10">
                        ...
                        <Link to="/contact">
                            <Button className="group bg-primary text-white hover:bg-blue-600 font-semibold shadow-lg relative overflow-hidden" size="lg">
                    ...
                    {/* Hero Icons */}
                    <div className="lg:w-1/2 relative flex justify-center" ref={parallaxHeroRef}>
                        <Zap className="absolute w-16 h-16 text-blue-300 top-10 left-1/4 hover:scale-110 hover:drop-shadow-xl transition-all duration-500" />
                        <Code className="absolute w-20 h-20 text-blue-400 bottom-10 right-1/3 hover:scale-110 hover:drop-shadow-xl transition-all duration-500" />
                        <Smartphone className="absolute w-14 h-14 text-blue-500 top-1/3 right-1/4 hover:scale-110 hover:drop-shadow-xl transition-all duration-500" />
                    </div>
                </div>
            </section>
            ...
            <section ref={el => el && sectionsRef.current.push(el)} className="py-20 bg-gray-50 relative overflow-hidden">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
                    {/* Story Icons */}
                    <div className="lg:w-1/2 relative flex justify-center order-1 lg:order-1" ref={parallaxStoryRef}>
                        <Users className="absolute w-16 h-16 text-green-300 top-10 left-1/4 hover:scale-110 hover:drop-shadow-xl transition-all duration-500" />
                        <Heart className="absolute w-14 h-14 text-pink-400 bottom-10 right-1/3 hover:scale-110 hover:drop-shadow-xl transition-all duration-500" />
                        <Target className="absolute w-20 h-20 text-yellow-400 top-1/3 right-1/4 hover:scale-110 hover:drop-shadow-xl transition-all duration-500" />
                    </div>

                    {/* SaaS Highlight Card */}
                    <div className="lg:w-1/2 order-2 lg:order-2 flex flex-col justify-center">
                        <div className="bg-gradient-to-r from-blue-100/80 to-blue-200/80 p-8 rounded-3xl shadow-inner shadow-blue-200/50 hover:shadow-xl hover:scale-[1.02] transition-all duration-500 transform">
                            <h2 className="text-3xl md:text-4xl font-extrabold text-blue-900 mb-4">Our Story</h2>
            ...
            <section ref={el => el && sectionsRef.current.push(el)} className="py-20 bg-gray-50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div ref={valuesRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {values.map(value => (
                            <div key={value.title} className="p-6 rounded-3xl bg-gradient-to-br from-white via-blue-50 to-white shadow-lg hover:shadow-2xl hover:scale-[1.05] transition-all duration-500 text-center opacity-0">
            ...
            <section ref={el => el && sectionsRef.current.push(el)} className="py-20 bg-gradient-to-br from-primary via-blue-600 to-indigo-700">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-3xl">
                    ...
                    <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">Global Reach, Local Touch</h2>
                    ...
                    <Link to="/contact">
                        <Button className="group bg-white text-primary hover:bg-blue-50 font-semibold shadow-xl relative overflow-hidden" size="lg">
