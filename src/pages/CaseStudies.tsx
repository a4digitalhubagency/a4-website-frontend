                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground">
                            Explore how we've helped startups and businesses achieve their
                            goals through innovative software solutions.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto">
                    <div ref={cardsRef} className="space-y-16">
                        {caseStudies.map((study, index) => (
                            <div
                                key={study.id}
                                className="grid lg:grid-cols-2 gap-8 items-center p-6 md:p-8 rounded-2xl bg-white border border-border/50 hover:border-primary/30 hover:shadow-xl transition-all duration-300 opacity-0"
                            >
                                {/* Image Placeholder */}
                                <div
                                    className={`aspect-video rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center ${index % 2 === 1 ? "lg:order-2" : ""
                                        }`}
                                >
